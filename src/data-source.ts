...
export const AppDataSource = new DataSource({
    ...
    entities: [ T_S02_TEMP, S13, S15, S31, S63, S65, T_S04_TEMP, T_S09_TEMP, T_S05_TEMP, T_G01_TEMP, T_G02_TEMP, T_G03_TEMP, T_G04_TEMP, T_G05_TEMP, T_G06_TEMP, T_G07_TEMP,
        T_G56, T_G57, T_G58, T_S93, T_S94, T_S96, T_S97, T_S06, T_S12, T_S14, T_S17, T_S24, T_G59, T_S52, T_S53, T_S59, T_S64, T_S82, T_S98, T_S95, T_G53, T_S67, T_S62
    ],
    migrations: [],
    subscribers: [],
})

export const Chulilla = new DataSource({
    type: "postgres",
    host: "localhost",
    port: 5432,
    username: "postgres",
